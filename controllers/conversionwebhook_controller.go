...
//+kubebuilder:rbac:groups=core.giantswarm.io,resources=conversionwebhooks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.giantswarm.io,resources=conversionwebhooks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.giantswarm.io,resources=conversionwebhooks/finalizers,verbs=update
...
func (r *ConversionWebhookReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.ConversionWebhook{}).
		Complete(r)
}
